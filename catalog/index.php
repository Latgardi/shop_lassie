...
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_MAIN_BLOCK_PROPERTY_CODE" => array("MATERIAL"),
		...
		"DETAIL_PROPERTY_CODE" => array("ARTNUMBER","BLOG_COMMENTS_CNT","MATERIAL","SEX","SIZE","SEASON","CONTENTS","DETAIL_LIST","CARE","FLAG","COLOR","NEWPRODUCT","MANUFACTURER","IMAGES",""),
		...
		"LIST_PROPERTY_CODE" => array("SIZE","FLAG","NEWPRODUCT","SALELEADER","SPECIALOFFER",""),
		...
		"MIN_AMOUNT" => "10",
		"OFFERS_CART_PROPERTIES" => array(0=>"SIZE",1=>"SIZES_CLOTHES",2=>"COLOR_REF",),
		...
		"SEF_FOLDER" => "/",
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => Array("compare"=>"compare/","element"=>"#SECTION_CODE_PATH#/#ELEMENT_CODE#/","section"=>"#SECTION_CODE_PATH#","sections"=>"","smart_filter"=>"#SECTION_CODE#/filter/#SMART_FILTER_PATH#/apply/"),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "Y",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
