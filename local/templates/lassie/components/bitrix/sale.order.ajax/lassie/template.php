...
else
{
	...
	?>
	<form class="form js-form-validate order-page__form" action="<?=POST_FORM_ACTION_URI?>" method="POST"
          name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
