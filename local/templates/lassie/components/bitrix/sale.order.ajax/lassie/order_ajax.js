...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		createBasketItem: function(basketItemsNode, item, index, active)
		{
			...
			cols = [
				BX.create('DIV', {
					props: {className: 'goods-table__cell'},
		...
		createBasketItemImg: function(data)
		{
			...
			return BX.create("DIV", {
				props: {className: "goods-table__col"},
		...
		createBasketItemContent: function(data)
		{
			...
			nodes.push(
				BX.create('DIV', {props: {className: 'goods-table__text'}, html: titleHtml})
			)
			...
			if (this.options.showPropsInBasket && props.length)
			{
				for (let i in props)
				{
					if (props.hasOwnProperty(i))
					{
						...
						nodes.push(
							BX.create('DIV', {
								props: {className: 'goods-table__info'},
								text: name + ": " + value
							})
						);
						/*propsNodes.push(
		...
		editActiveRegionBlock: function(activeNodeMode)
		{
			...
			else
			{
				...
				regionNode = BX.create('DIV', {props: {className: 'form__row'}});
